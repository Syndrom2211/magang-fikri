            ...
            <Col md={6} className="music-section">
              <div className="music-content">
                ...
                <p className="inspiration-text">
                  "Dengar suara hujan, lihat matahari terbit, rasakan detak
                  jantungmu. Setiap lagu besar dimulai dari satu kata sederhana.
                  Tulis apa yang kamu rasakan. Musik ada di mana-mana."
                </p>
                <h4 className="ai-title">
                  AND CREATE YOUR <span>MUSIC WITH AI</span>
                </h4>
                <textarea
