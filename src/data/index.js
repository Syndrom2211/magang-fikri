    ...
    ID: [
      {
        ...
        genre: "Accoustic",
        audio: "Accoustic/1. Dapoer Catering SR.mp3",
      },
      {
        id: 2,
        name: "BnC Cookies Bandung",
        genre: "Accoustic",
        audio: "Accoustic/2. BnC Cookies Bandung (Kue Kering Version).mp3",
      },
      {
        id: 3,
        name: "Anugerah Cipta Arsitektur",
        genre: "Accoustic",
        audio: "Accoustic/3. Anugerah Cipta Arsitektur.mp3",
      },
      {
        id: 4,
        name: "Goyobod Laris",
        genre: "Dubstep",
        audio: "Dubstep/4. Goyobod Laris.mp3",
      },
      {
        id: 5,
        name: "Adiguna Outdoor Store",
        genre: "Dubstep",
        audio: "Dubstep/5. Adiguna Outdoor Store.mp3",
      },
      {
        id: 6,
        name: "Aumone Project",
        genre: "Dubstep",
        audio: "Dubstep/6. Aumone Project.mp3",
      },
      {
        id: 7,
        name: "Elsiera Official",
        genre: "Dubstep",
        audio: "Dubstep/7. Elsiera Official.mp3",
      },
      {
        id: 8,
        name: "Enstie Gallery",
        genre: "Dubstep",
        audio: "Dubstep/8. Enstie Gallery.mp3",
      },
      {
        id: 9,
        name: "Fikri Filaili, Bagaimana kabarmu",
        genre: "Dubstep",
        audio: "Dubstep/9. Fikri Filaili, Bagaimana kabarmu_.mp3",
      },
      {
        id: 10,
        name: "Maestro Swim",
        genre: "Dubstep",
        audio: "Dubstep/10. Maestro Swim.mp3",
      },
      {
        id: 11,
        name: "Toko Sepatu Madara Madani",
        genre: "Dubstep",
        audio: "Dubstep/11. Toko Sepatu Madara Madani.mp3",
      },
      {
        id: 12,
        name: "Dimsum by Inmons Fix",
        genre: "Jazz",
        audio: "Jazz/12. Dimsum by Inmons Fix.mp3",
      },
      {
        id: 13,
        name: "Kinabanin",
        genre: "Jazz",
        audio: "Jazz/13. Kinabanin.mp3",
      },
      {
        id: 14,
        name: "Komunitas Ruang Berbagi",
        genre: "Jazz",
        audio: "Jazz/14. Komunitas Ruang Berbagi.mp3",
      },
      {
        id: 15,
        name: "Mengapa Terjadi Bencana",
        genre: "Jazz",
        audio: "Jazz/15. Mengapa Terjadi Bencana.mp3",
      },
      {
        id: 16,
        name: "Bubuk Cabe Pa Abdul",
        genre: "Pop",
        audio: "Pop/16. Bubuk Cabe Pa Abdul.mp3",
      },
      {
        id: 17,
        name: "Sinai Adventure",
        genre: "Pop",
        audio: "Pop/17. Sinai Adventure.mp3",
      },
      {
        id: 18,
        name: "MBN Optic",
        genre: "Pop",
        audio: "Pop/18. MBN Optic.mp3",
      },
      {
        id: 19,
        name: "Aku Baru",
        genre: "Progressive",
        audio: "Progressive/19. Aku Baru.mp3",
      },
      {
        id: 20,
        name: "Menemukanmu",
        genre: "Progressive",
        audio: "Progressive/20. Menemukanmu.mp3",
      },
      {
        id: 21,
        name: "Kebaikan dan Keburukan",
        genre: "Progressive",
        audio: "Progressive/21. Kebaikan dan Keburukan.mp3",
      },
      {
        id: 22,
        name: "Hudang Hese",
        genre: "Sundanese",
        audio: "Sundanese/22. Hudang Hese.mp3",
      },
      {
        id: 23,
        name: "Sabar Ning",
        genre: "Sundanese",
        audio: "Sundanese/23. Sabar Ning.mp3",
      },
    ],  
  EN: [
    {
